...
parser.add_argument("--root", type=str, default="/home/ubuntu/workplace/pjh/data/train",
...
testset = Set5_val.DatasetFromFolderVal("/home/ubuntu/workplace/pjh/data/test/celeb128",
                                       "/home/ubuntu/workplace/pjh/data/test/celeb16_downx8/LRbicX8",
                                       args.scale)
...
def valid():
    ...
    for batch in testing_data_loader:
        ...
        # print(f"sr_img:{sr_img.shape}")
        # print(f"gt_img:{gt_img.shape}")
        ...
        if args.isY is True:
            ...
            im_label = gt_img
            im_pre = sr_img
        # print(f"im_pre:{im_pre.shape}")
        # print(f"im_label:{im_label.shape}")
...
# CUDA_VISIBLE_DEVICES=1 nohup python -u train_IMDN.py --scale 8 > IMDN_CelebA_2.29.log 2>&1 &
# ps -ef | grep IMDN | grep -v grep | awk '{print $2}' | xargs kill -9
